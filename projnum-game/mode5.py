...
class RightMenu:
    ...
    def prepare_menu(self):
        ...
        posY += 20
        messageList = ["Dans ce Mode de jeu, on utilise tout ce"
                     , "qui a été vu avant."
                     , "Il faut utiliser le combustible fissible"
                     , "pour contrôler la réaction en chaîne "
                     , "qui chauffe l'eau par absorbtion. La "
                     , "réaction doit être assez forte pour "
                     , "s'entretenir tandis que les neutrons "
                     , "sont absorbés."
                     , "Le but est de produire 100kWh d'éner-"
                     , "gie sans dépasser 800 neutrons et "
                     , "sans que le réacteur ne s'éteigne."
        ]
        ...
        messageList = [ "Neutron lent"
            , "Neutron rapide"
            , "Cellule d'eau froide"
            , "Cellule d'eau chaude"
            , "Cellule de vapeur"
            , "Uranium-235"
            , "Xénon-135"
